                ...
                <div className="card-body">
                  ...
                  <div className="detail_flex">
                    <p className="card-text">
                      These friendly and knowledgeable folks are here to help
                      answer your questions 24/6 <br /> via chat or email.
                    </p>
              ...
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title">
                    Support trends, delivered weekly
                  </h5>
                  <p className="card-text">
                    A dose of weekly support news you’ll actually want to read.
                  </p>
                </div>
                <img
                  src={myImg12}
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title">
                    Guides, courses, and content (for free)
                  </h5>
                  <div className="detail-flex">
                    <p className="card-text">
                      Level up your skills with free resources, created for
            ...
            <div className="col-md-6">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    A quarterly publication for curious people who want to lead
                    with values and grow with grit.
                  </p>
                </div>
                <img
                  src={myImg2}
