...
const MainContent = () => {
  ...
  return (
    ...
    <div className='container'>
        <h1 className='heading'>Every <span id="changingText" style={{ display: "inline-block" }}>{texts[currentTextIndex]}</span> Conversation</h1>
        <h1 className='heading_headline'>One unified platform</h1>
        <div className='heading_button'>
        <button type="button" class="btn btn-primary btn-lg">Explore the Platform</button>
        </div>
    </div>
    </>
  )
